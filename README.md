...
Once Dagalti is installed it is time to redirect your http and https requests in your working project to the Dagalti. This is fairly straight-forward for many platforms. 

For ex. in Java to redirect all http requests through a proxy, please follow [this link]
